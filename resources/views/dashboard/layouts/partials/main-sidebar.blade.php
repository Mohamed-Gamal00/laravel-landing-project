...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active justify-content-center">
        <h2 style="font-family: fantasy;" class="text-danger">Landing page</h2>
    ...
    <div class="main-sidemenu">
                ...
                <div class="user-info">
                    @if (Auth::check())
                        <div class="pull-left info">
                            <p class="font-weight-semibold mt-3 mb-0">{{ Auth::user()->name }}</p>
                        </div>
                    @endif
        ...
        <ul class="side-menu">
            ...
            @can('categories')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('category.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                            <path
            ...
            @can('posts')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('post.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                            <path
                                d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                        </svg><span class="side-menu__label">posts</span></a>
                </li>
            @endcan

            @can('contacts')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('contact.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                            <path
                                d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                        </svg><span class="side-menu__label">contacts</span></a>
                </li>
            @endcan
            ...
            @can('settings')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('settings.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                        </svg><span class="side-menu__label">settings</span></a>
                </li>
            @endcan

            @can('projects')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('project.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                            <path
                                d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                        </svg><span class="side-menu__label">projects</span></a>
                </li>
            @endcan

            @can('services')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('services.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                            <path
                                d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                        </svg><span class="side-menu__label">services</span></a>
                </li>
            @endcan
            ...
            <li class="slide">
                <form class="p-3" id="logout-form" action="{{ route('logout') }}" method="POST">
                    @csrf
